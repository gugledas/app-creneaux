((typeof self !== 'undefined' ? self : this)["webpackJsonpappCreneau"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpappCreneau"] || []).push([[2],{
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"40e88119-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TestRequestshopify.vue?vue&type=template&id=7bd9fdb4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('button',{on:{"click":_vm.testRequest}},[_vm._v("test request")])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/TestRequestshopify.vue?vue&type=template&id=7bd9fdb4&
...
var basicRequest = {
  ...
  BaseUrl: function BaseUrl() {
    return (window.location.host.includes("localhost") || window.location.host.includes(".kksa")) && this.TestDomain ? this.TestDomain.trim("/") : window.location.protocol + "//" + window.location.host;
  },
...
/* harmony default export */ var configs_config = ({
  post: function post() {
    var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "https://stephane-kouwa.myshopify.com/admin/api/2021-07/products.json";
    Object(app_bridge_utils["getSessionToken"])(window.app).then(function (token) {
      var config = {
        headers: {
          Authorization: "Bearer ".concat(token)
        }
      };
      basic.get(url, config);
    });
  },
  get: function get() {
    var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "https://stephane-kouwa.myshopify.com";
    Object(app_bridge_utils["getSessionToken"])(window.app).then(function (token) {
      var config = {
        headers: {
          Authorization: "Bearer ".concat(token)
  ...
  getHost: function getHost(url, data) {
    return basic.post(url, data);
  }
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/TestRequestshopify.vue?vue&type=script&lang=js&
//
//
//


/* harmony default export */ var TestRequestshopifyvue_type_script_lang_js_ = ({
  ...
  methods: {
    testRequest: function testRequest() {
      ...
      Object(app_bridge_utils["getSessionToken"])(window.app).then(function (token) {
        configs_config.getHost("/shopify-api-rest/request/LoadMetafields?token=" + token + "&shop=" + _this.shop, {
...
// CONCATENATED MODULE: ./src/components/TestRequestshopify.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_TestRequestshopifyvue_type_script_lang_js_ = (TestRequestshopifyvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/components/TestRequestshopify.vue
...
var TestRequestshopify_component = Object(componentNormalizer["a" /* default */])(
  components_TestRequestshopifyvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var TestRequestshopify = __webpack_exports__["default"] = (TestRequestshopify_component.exports);

/***/ })

}]);
//# sourceMappingURL=appCreneau.common.2.js.map